...
#+BEGIN_SRC emacs-lisp
  ...
  (defun setup-linux-ansi-term ()
    ...
    (custom-set-faces
     ...
     '(term-color-cyan ((t (:foreground "#BBAA55" :background "#8CD0D3"))))
    ...
    (if (eq system-type 'gnu/linux)
	(setup-linux-ansi-term))

#+END_SRC

*** Char/Line Mode Linux
#+BEGIN_SRC emacs-lisp
  (eval-after-load "term"
    (progn
      '(define-key term-raw-map (kbd "C-x C-k") 'kill-this-buffer)))
#+END_SRC
