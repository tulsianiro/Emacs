...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'lazy-highlight nil :background "#00009f")
  (set-face-attribute 'show-paren-match nil :background nil :foreground "DarkGoldenrod3" :weight 'extra-bold)
#+END_SRC
