...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'isearch nil :weight 'extra-bold :background "midnight blue" :foreground "white")
  (set-face-attribute 'lazy-highlight nil :weight 'extra-bold :background "gray25" :foreground "gold2")
