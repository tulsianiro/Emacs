...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'isearch nil :background "midnight blue" :foreground "white")
  (set-face-attribute 'lazy-highlight nil :background "midnight blue" :foreground "burlywood3")
