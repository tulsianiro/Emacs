...
#+BEGIN_SRC emacs-lisp
  ...
  (set-face-attribute 'isearch nil :weight 'extra-bold :background "midnight blue" :foreground "burlywood3")
  (set-face-attribute 'lazy-highlight nil :weight 'extra-bold :foreground "burlywood3" :background "#402240")
...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-c f") 'first-error)
#+END_SRC
